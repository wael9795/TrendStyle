...
const Navbar = () => {
  ...
  return (
    <div className="flex justify-between items-center py-5 font-medium sticky top-0 bg-white z-50 border-b border-gray-200">
      <Link to="/">
        <img src={assets.logo05} className="w-44 absolute left-0 top-0" alt="" />
      </Link>
          ...
          {token && (
            <div className="group-hover:block hidden absolute dropdown-menu right-0 pt-4">
              <div className="flex flex-col gap-2 w-36 py-3 px-5 bg-slate-200 text-gray-700 rounded">
                ...
                <p onClick={logout} className="cursor-pointer hover:text-gray-500">
                  Logout
                </p>
              </div>
            </div>
